...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("int", "TELEGRAM_API_ID", tgApiId.toString())
        buildConfigField("String", "TELEGRAM_API_HASH", "\"$tgApiHash\"")
...
dependencies {
    ...
    // TDLib (Bundled Multi-ABI Native Libraries + Java bindings)
